  ...
  return (
    <div className='productslist'>
      <div className='psucat'>
        <p>Products - <span className='casespan'>Keyboard</span></p>
      </div>
      <div className='articlecontain'>
        {displayedProducts.map((product, index) => (
          <div className='article' key={index}>
            ...
            <p>Switches: {product.switches}</p>
            <p>Backlit: {product.backlit}</p>
            <p>Connection: {product.connection_type}</p>
